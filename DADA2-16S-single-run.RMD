...
```{r set-path}
path <- "/path/to/data/folder" ## CHANGE THIS to the folder with your raw data

list.files(path) # print files in folder to console
```
...
If a large proportion of your reads are not merging
1) your parameters are too loose, OR 
2) you have trimmed your reads too short

Either way, you'll have to go back to the filterAndTrim chunk and change your parameters
